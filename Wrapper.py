...
import ee
import Remote_Sensing.border_noise_correction as bnc
import speckle_filter as sf
import terrain_flattening as tf
...
def s1_preproc(params):
    ...
    if (APPLY_SPECKLE_FILTERING):
        if (SPECKLE_FILTER_FRAMEWORK == 'MONO'):
            ...
            s1_1 = ee.ImageCollection((s1_1, SPECKLE_FILTER_KERNEL_SIZE, SPECKLE_FILTER, SPECKLE_FILTER_NR_OF_IMAGES))
